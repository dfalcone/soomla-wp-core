...
namespace SoomlaWpCore
{
    ...
    public class SoomlaUtils
    {
        ...
        public static String DeviceId()
        {
            ...
            IBuffer packageId = token.Id;

            DataReader dataReader = DataReader.FromBuffer(packageId);
            byte[] myDeviceID = new byte[packageId.Length];
            dataReader.ReadBytes(myDeviceID);
